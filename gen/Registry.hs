...
deshenaniganize registry = registry
	{ registryFeatures = map clean44feature
	                   . map clean45feature
	                   $ registryFeatures registry
	}

clean44feature :: Feature -> Feature
clean44feature feature | featureName feature == "GL_VERSION_4_4" = feature
	{ featureRequires = map clean44require $ featureRequires feature
	}
clean44feature feature = feature
...
clean45feature feature | featureName feature == "GL_VERSION_4_5" = feature
	{ featureRequires = map clean45require $ featureRequires feature
	}
clean45feature feature = feature
